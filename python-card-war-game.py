...
def game_structure(player1_deck, player2_deck, player_names, player_scores, war_cards):
  ...
  # Joker check
  if "Joker" in card1 or "Joker" in card2:
    player_scores['player 1'] = 0
    player_scores['player 2'] = 0
    ...
    return True  # End round immediately, no points awarded
...
def game_final():
  ...
  if load_choice == 'yes':
    ...
    if state:
      ...
      new_after_error = input("Would you like to start a new game instead? (yes/no): ")
